...
// src/api/authorizer/node_modules/aws-jwt-verify/dist/esm/error.js
...
// src/api/authorizer/node_modules/aws-jwt-verify/dist/esm/node-web-compat-node.js
var import_crypto = require("crypto");

// src/api/authorizer/node_modules/aws-jwt-verify/dist/esm/asn1.js
var Asn1Class;
(function(Asn1Class2) {
...
// src/api/authorizer/node_modules/aws-jwt-verify/dist/esm/https-node.js
var import_https = require("https");

// src/api/authorizer/node_modules/aws-jwt-verify/dist/esm/https-common.js
...
// src/api/authorizer/node_modules/aws-jwt-verify/dist/esm/safe-json-parse.js
...
// src/api/authorizer/node_modules/aws-jwt-verify/dist/esm/https.js
...
// src/api/authorizer/node_modules/aws-jwt-verify/dist/esm/assert.js
...
// src/api/authorizer/node_modules/aws-jwt-verify/dist/esm/jwk.js
...
// src/api/authorizer/node_modules/aws-jwt-verify/dist/esm/jwt-model.js
...
// src/api/authorizer/node_modules/aws-jwt-verify/dist/esm/jwt.js
...
// src/api/authorizer/node_modules/aws-jwt-verify/dist/esm/jwt-rsa.js
...
// src/api/authorizer/node_modules/aws-jwt-verify/dist/esm/cognito-verifier.js
...
var CognitoJwtVerifier = class _CognitoJwtVerifier extends JwtRsaVerifierBase {
  ...
  static parseUserPoolId(userPoolId2) {
    const match = userPoolId2.match(/^(?<region>(\w+-)?\w+-\w+-\d)+_\w+$/);
    if (!match) {
...
var appClientId = process.env.APPLICATION_CLIENT_ID || "";
var adminGroupName = process.env.ADMIN_GROUP_NAME;
var HttpVerb = {
  GET: "GET",
  POST: "POST",
  PUT: "PUT",
...
var AuthPolicy = class {
  constructor(principal, awsAccountId, apiOptions) {
    ...
    this.allowMethods = [];
    this.denyMethods = [];
    this.restApiId = apiOptions?.restApiId || "iaqda95tae";
    this.region = apiOptions?.region || "us-east-1";
    this.stage = apiOptions?.stage || "prod";
  }
  /**
...
var handler = (event, context) => {
  ...
  return verifier.verify(jwtToken).then((result) => {
